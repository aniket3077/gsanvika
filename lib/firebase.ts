...
const firebaseConfig = {
  ...
  databaseURL: process.env.NEXT_PUBLIC_FIREBASE_DATABASE_URL || "https://e-com-620fe-default-rtdb.firebaseio.com",
  ...
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:829977668997:web:fbb8db48d0e1ee7dc7e8ec",
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-5KFPMKXJWN"
}
